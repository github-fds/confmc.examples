...
set_property -dict [list CONFIG.Fifo_Implementation {Common_Clock_Block_RAM}\
                         ...
                         CONFIG.Input_Depth [expr ${DEPTH}/4]\
                         ...
                         CONFIG.Full_Threshold_Assert_Value [expr ${DEPTH}/4-3]\
                         CONFIG.Full_Threshold_Negate_Value [expr ${DEPTH}/4-4]\
