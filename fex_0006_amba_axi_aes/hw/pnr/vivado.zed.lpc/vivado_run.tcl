...
if {[info exists env(VIVADO_VERSION)] == 0} {
     ...
     set VIVADO_VER vivado.$::env(VIVADO_VERSION)
}
...
#proc proc_read { {out_dir ${WORK}} {part ${DEVICE}} {module ${MODULE}} { rigor 0 } } {
     ...
     set DIR_AES_FIFO   "${DIR_AES}/fifo_sync/$::env(FPGA_TYPE)/${VIVADO_VER}"
     set DIR_AES_MEM    "${DIR_AES}/mem_dual_port/$::env(FPGA_TYPE)/${VIVADO_VER}"
     set DIR_XDC        "xdc"
     ...
     read_verilog  "
                ...
                ${DIR_AES}/rtl/verilog/aes128_axi_stub.v
     "
