...
task axi_write_burst;
     ...
     input [ 1:0] burst; // 00=fixed, 01=inc
     integer idx;
begin
     u2f_data[0] = {16'h2,4'b0010,4'h0,4'h0,4'h0};
     u2f_data[1] = trx_cmd(1'b1, size, bleng[11:0], burst, 3'b0, 4'b0, 4'b1, 2'b0);
     u2f_data[2] = addr;
...
begin
     u2f_data[0] = {16'h2,4'b0010,4'h0,4'h0,4'h0};
     u2f_data[1] = trx_cmd(1'b0, size, bleng[11:0], burst, 3'b0, 4'b0, 4'b1, 2'b0);
     u2f_data[2] = addr;
...
// Revision History
//
// 2019.06.15: axi_read/write_burst() added with burst-type
