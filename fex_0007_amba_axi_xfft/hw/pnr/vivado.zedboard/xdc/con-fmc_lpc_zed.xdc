...
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_DT_O*}]
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_RD_N}]
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_WR_N}]
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_OE_N}]
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_PKTEND_N}]
#set_property IOB TRUE  [get_cells {u_dut/u_bfm_axi/u_gpif2mst/SL_AD*}]
# use this in tcl: set_property IOB true [ all_inputs  ]
# use this in tcl: set_property IOB true [ all_outputs ]
